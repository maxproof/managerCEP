...
<div class="main">
	...
	<h4>Edition Catégorie Sélectionnée pour les Entreprises</h4>
	<br />
	<p>${message}</p>
	<form:form method="POST" commandName="category"
		action="${pageContext.request.contextPath}/category/edit/${category.id_category}.html">
		<div class="row">
			<div class="col-md-5">
				<table>
					<tbody>
						<tr>
							...
							<td><spring:bind path="categoryName">
									<p class="h6 ${status.error ? 'has-error' : ''}">
										<c:if
											test="${category.categoryName=='Club-Entreprises' || category.categoryName=='Membre individuel'}">

...
<script type="text/javascript">
	function checkForm(form) {
		...
		var x = document.forms["addusercep"]["userCepEmail"].value;
		var atpos = x.indexOf("@");
...
<p>Session utilisateur <b>${pageContext.request.userPrincipal.name}</b></p>
	...
	<br />
	<form:form method="POST" commandName="userCep" id="addusercep"
		name="addusercep"
		action="${pageContext.request.contextPath}/usercep/add.html"
				...
				<table>
					<tbody>
						<tr>
							...
							<td><p class="h6">
									<form:input path="userCepFirstName" class="form-control"
										name="userCepFirstName" maxlength="50"/>
								</p></td>
						</tr>
						<tr>
							<td><p class="h6">
						...
						<tr>
							...
							<td><spring:bind path="userCepLogin">
									<p class="h6 ${status.error ? 'has-error' : ''}">
										<form:input path="userCepLogin" class="form-control"
											name="userCepLogin" maxlength="50"/>
									</p>
									<form:errors path="userCepLogin" style='color:red;' />
								</spring:bind></td>
						</tr>
						<tr>
							<td><p class="h6">
							...
							<td><spring:bind path="userCepPassword">
									<p class="h6 ${status.error ? 'has-error' : ''}">
										<form:input path="userCepPassword" class="form-control" maxlength="50"/>
									</p>
									<form:errors path="userCepPassword" style='color:red;' />
								</spring:bind></td>
						</tr>
						<tr>
							<td><p class="h6">
							...
							<td><spring:bind path="userCepEmail">
									<p class="h6 ${status.error ? 'has-error' : ''}">
										<form:input path="userCepEmail"
											placeholder="email@domaine.com" class="form-control"
											name="userCepEmail" maxlength="50"/>
									</p>
									<form:errors path="userCepEmail" style='color:red;' />
								</spring:bind></td>
						</tr>
						<tr>
							<td><p class="h6">

...
<div class="main">
	...
	<h4>Edition Membre Mobile Sélectionné</h4>
	<br />
	<p>${message}</p>
	<form:form method="POST" commandName="memberMob"
		action="${pageContext.request.contextPath}/membermob/edit/${memberMob.id_memberMob}.html">
		<div class="row">
			<div class="col-md-5">
				<table>
					<tbody>
						<tr>
							...
							<td><spring:bind path="memberMobLastName">
									<p class="h6 ${status.error ? 'has-error' : ''}">
										<form:input path="memberMobLastName" class="form-control" maxlength="50"/>
									</p>
